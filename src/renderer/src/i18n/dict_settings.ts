...
export const settingsDict: DomainDict = {
  en: {
    ...
    'settings.basic.pipelineChecklistSub':
      'Show the retrieve / rerank / prefill pipeline beneath the answer. It stays collapsed — expand it for per-step timings. Off by default.',
    'settings.basic.pipelineCollapse': 'Hidden',
    'settings.basic.pipelineKeepVisible': 'Shown',
    'settings.basic.pipelineVisibility': 'Pipeline visibility',
  ...
  de: {
    ...
    'settings.basic.pipelineChecklistSub':
      'Zeigt die Retrieve-/Rerank-/Prefill-Pipeline unter der Antwort. Bleibt eingeklappt — zum Anzeigen der Schritt-Zeiten aufklappen. Standardmäßig aus.',
    'settings.basic.pipelineCollapse': 'Ausgeblendet',
    'settings.basic.pipelineKeepVisible': 'Eingeblendet',
    'settings.basic.pipelineVisibility': 'Sichtbarkeit der Pipeline',
