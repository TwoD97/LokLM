...
export const authDict: DomainDict = {
  en: {
    ...
    // WarmingView (post-unlock model loading screen)
    'auth.warmTitle': 'Getting things ready',
    'auth.warmLead': 'Loading the models your questions will use.',
    'auth.warmVault': 'Vault unlocked',
    'auth.warmLlm': 'Language model',
    'auth.warmEmbedder': 'Search index',
    'auth.warmReranker': 'Reranker',
    'auth.warmReady': 'Ready',
    'auth.warmPending': 'Pending',
    'auth.warmFailed': 'Unavailable',
    'auth.warmContinue': 'Continue anyway →',
  ...
  de: {
    ...
    // WarmingView (Lade-Bildschirm nach dem Entsperren)
    'auth.warmTitle': 'Alles wird vorbereitet',
    'auth.warmLead': 'Die Modelle für deine Fragen werden geladen.',
    'auth.warmVault': 'Tresor entsperrt',
    'auth.warmLlm': 'Sprachmodell',
    'auth.warmEmbedder': 'Suchindex',
    'auth.warmReranker': 'Reranker',
    'auth.warmReady': 'Bereit',
    'auth.warmPending': 'Wartet',
    'auth.warmFailed': 'Nicht verfügbar',
    'auth.warmContinue': 'Trotzdem fortfahren →',
