...
| **Version**         | 1.1.1 (Nachtrag) — Original 1.0 signiert am 15.05.2026; v1.1 ergänzte SMART-Ziele am 18.05.2026 |
| **Dateiname**       | Pflichtenheft_LokLM.md                                                                          |
| **Ort, Datum**      | Salzburg, 15.05.2026 (Nachtrag v1.1.1: 20.05.2026)                                              |
...
| Embeddings         | BGE-M3 (1024-dim, GGUF Q4_K_M, multilingual) _(Nachtrag v1.1.1: war v1.0 als snowflake-arctic-embed-l-v2.0 spezifiziert; BGE-M3 wurde mit Spec 1 gewählt wegen DE+EN-Coverage und Reranker-Kompatibilität)_ | Lokale Embedding-Berechnung                                                                                                                                                 |
| Sprachmodell       | Qwen3-8B-Instruct (Q4_K_M, GGUF)                                                                                                                                                                            | Antwortgenerierung mit aktiviertem `/no_think`-Modus                                                                                                                        |
...
| Modell-Profil                    | lite / full / xl                     | abhängig von verfügbarem RAM | Wechsel löst Modell-Reload aus                 |
...
| Sprache der UI                   | Deutsch / Englisch                   | Deutsch                      | i18n                                           |
