...
Tests werden auf folgenden Konfigurationen durchgeführt und in `docs/hw-matrix.md` dokumentiert (Owner: Denys):
...
| HW-2 | Notebook (Mittelklasse)      | 16 GB  | integriert                | full              | M1–M9              |
...
**Hold-out-Set:** 15 separat gehaltene Testfälle, die während der Entwicklung nicht eingesehen werden. Erst beim finalen Eval werden sie verwendet (Echo-Kammer-Schutz, siehe Risiko R5).
...
| **Faithfulness**      | Anteil der antwortenden Aussagen, die durch die zitierten Chunks gestützt sind (manuelle Bewertung bei einer 20er-Stichprobe; automatische Annäherung mit Substring-Match auf `expected_answer_substring` für die volle Menge) |
...
| AP-1.2  | Lastenheft                                                                                                                                      | —              | AP-1.3         | Denys           | 10            |
| AP-1.3  | Teamregeln, Projektsteckbrief                                                                                                                   | AP-1.2         | AP-2.x         | Denys           | 3             |
...
| AP-2.2  | Auth-UI (Login, Register, Recovery-Code-Anzeige, Sperrbildschirm)                                                                               | AP-2.1         | AP-9           | Denys           | 12            |
...
| AP-3.4  | DOCX-Import (mammoth, Tabellen→Pipe-Zeilen, bekannte Limits dokumentieren)                                                                      | AP-3.1         | AP-4.1         | Denys           | 10            |
...
| AP-6    | Suche- und Filter-UI (Eingabefeld, ts_headline-Highlighting, Sortierung, Filter)                                                                | AP-4.4         | AP-7           | Denys           | 6             |
...
| AP-9    | Settings-UI (Chunkgröße, K, Modell-Profil, Theme, Inaktivitäts-Sperre, Account-Bereich)                                                         | AP-2.1         | —              | Denys           | 8             |
...
| AP-D.1  | Verteilungs-Homepage (eigene Domain auf Hetzner-VM, Hero, Screenshots, Download-Verweis, Doku-Link) _(Nachtrag v1.1.1: GitHub Pages → Hetzner)_ | AP-1.1         | AP-12          | Denys           | 12            |
| AP-D.2  | Anwenderhandbuch (Erstinbetriebnahme, alle Hauptabläufe, Troubleshooting, bekannte Limits)                                                      | AP-7, AP-8     | AP-12          | Denys           | 14            |
| AP-D.3  | Technische Dokumentation und ADRs (Briefing-basiert von Denys; Architektur, Services, Schema, IPC)                                              | AP-2.1, AP-4.4 | AP-12          | Denys           | 14            |
| AP-D.4  | TypeDoc-Generierung und Einbindung in die Verteilungs-Homepage (Hetzner-VM) _(Nachtrag v1.1.1)_                                                 | AP-1.1         | AP-12          | Denys           | 3             |
| AP-T.1  | Vitest Unit-Tests (chunker, parser, RetrievalService-RRF, Citation-Parser, Auth-Wrapper)                                                        | AP-1.1         | AP-T.2         | Denys           | 10            |
| AP-T.2  | Modul-/Integrations-Tests (DocumentService E2E, RetrievalService E2E, Auth E2E mit Snapshot-Round-Trip)                                         | AP-T.1         | AP-T.3         | Denys           | 8             |
| AP-T.3  | Manuelle Testszenarien M1–M11 ausgeführt und protokolliert                                                                                      | AP-7.4, AP-8   | AP-T.4         | Denys           | 8             |
| AP-T.4  | Multi-Hardware-Test-Matrix (HW-1 bis HW-4, Performance-Messung, Beobachtungen)                                                                  | AP-T.3         | AP-12          | Denys           | 8             |
| AP-E.1  | Eval-Set Synthetic-Data-Authoring (50–80 Fälle DE+EN inkl. 15 Hold-out-Fälle)                                                                 | AP-7.2         | AP-E.2         | Denys           | 12            |
...
| UI-, Test- & Doku-Säule (Auth-UI, DOCX, Settings-UI, Tests, Doku, Synthetic Data, Homepage + Präsentation) | **145** |
...
| R3                                       | Engpass bei Dokumenten- und Test-Breite                                                                                                     | 3 × 4                 | Wöchentliche 30-Min-Briefings; 5–10-Bullet-Outlines für die schwersten Dokumente; Cut-Order: Homepage-Detail → Hardware-Matrix-Detail → ADR-Tiefe → DOCX zuletzt; Ghostwriting für Fortschrittsbericht bei Ausfall > 3 Tage                                                                                                                                                               |
| R4                                       | DOCX-Parsing-Sonderfälle (Tabellen, verschachtelte Listen, Fußnoten) verschlingen unverhältnismäßig Zeit                                    | 2 × 2                 | Verwendung von `mammoth` (etabliert); Akzeptanz "nur Text-Body, Tabellen als Pipe-Zeilen, Bilder ignoriert" in Pflichtenheft 3.2.4 fest verdrahtet; bekannte Limit. im Anwenderhandbuch dokumentiert                                                                                                                                                                                      |
| R5                                       | Eval-Set ist Echo-Kammer (Denys schreibt Code, schreibt Tests, scort Ergebnisse)                                                            | 4 × 3                 | Hold-out-Set: 15 separat verfasste Testfälle, die während der Entwicklung nicht eingesehen werden; reale PDFs (z. B. `school_req`-Inhalte) werden bevorzugt; manuelle Faithfulness-Bewertung bei 20er-Stichprobe                                                                                                                                                                          |
...
| R7                                       | Krankheits-/Ausfall-Risiko bei knappem Zeitplan                                                                                             | 3 × 4                 | Pufferwoche Woche 7 ist genau dafür reserviert. Tägliche Commits + PR-Beschreibungen ersetzen Wissen-Übergabe; Doku kann auch asynchron in Abendstunden weitergeführt werden                                                                                                                                                                                                              |
...
| ------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- |
| 0.1     | 13.05.2026 | Initialer Entwurf                                                                                                                                                                                                                                                                                                                                                                                                                          | Projektgruppe  |
