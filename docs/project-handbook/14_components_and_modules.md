...
| **Status**         | umgesetzt                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Grenzen**        | Das LLM ist **nicht** mehr im Laufzeit-Manifest (seit v0.4.x) — der Installer-Wizard besitzt die LLM-Akquise per Tier-Bundle; LLM-Erkennung läuft filename-pattern-basiert. Die **In-App-Erststart-Download-Ansicht (`ModelDownloadView`) ist seit v0.4.7 entfernt**: Die App startet direkt in die Auth-Phase, ein fehlendes Modell erscheint als _not-ready_-Dienst statt als Download-Aufforderung (der `ModelDownloader`-Dienst samt `models:*`-IPC bleibt erhalten) |
