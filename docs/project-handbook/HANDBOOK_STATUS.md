...
| 13   | Technische Architektur             | zu pruefen   | ja (Quellcode, ADRs)                                       | IPC-Handler-Gesamtzahl geklärt → **103** (Stand v0.4.6 `af59c25`, = Kap. 13; auf späterem main v0.4.7: 105); ADR-0004-Implementierungsstand geklärt → NICHT implementiert (kein `placement/`-Code), reiner Design-Vorschlag (PROPOSED) | niedrig |
