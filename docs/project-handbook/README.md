...
Stand: **2026-06-16** · Handbuch-Version **0.1** · Projektstand nach ca. 9 Wochen Projektarbeit; technische Kapitel mit `main` (v0.4.6) abgeglichen. Test-/Eval-Deliverables (AP-E.1/E.2/T.1/T.2) liegen auf noch nicht gemergten Feature-Branches — siehe Marker in Kap. 11/15/17/19.
