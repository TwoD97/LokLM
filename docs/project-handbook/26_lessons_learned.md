...
### 1.1 Symptom ≠ Ursache (LockedError war ein veralteter Build)
...
### 1.2 Span-Metriken sind chunker-unabhängig
...
### 1.3 Modellgröße ≠ Antwortqualität bei gutem RAG
...
### 1.4 Spec ≠ aktueller Schema-Stand
...
### 1.5 Determinismus muss erzwungen werden
...
### 1.6 Echte Daten zeigen Daten-Defekte
...
## 2. Projektmanagement-Erkenntnisse
...
### 3.1 Notwendigkeit eines Lizenz-Gates
...
### 3.2 Memory-hard KDF statt schwacher Default-Wahl
...
### 3.3 Sicherheitshärtung gehört in die Plattform, nicht in den Feature-Code
...
### 3.4 Adaptive Modell-Residenz statt fixer Größe
...
## 4. KI-Unterstützung (Claude / Codex): Nutzen und Grenzen
...
## 5. Fehler, Umwege, und was beim nächsten Projekt anders wäre
