...
| Features: Quiz / DOCX-Import / Folder-Sync | App | P | drei Nutzer-Features | MCQ-Quiz, mammoth-DOCX-Parser [15], Folder-Sync-Service + Migrationen 0003–0005 | **fertig** | mittel | `…05-22.md` (Phase 5) |
