...
| AP-9 (Account) | Account: neue Recovery-Codes         | Auth/UI      | D     | Recovery-Code-Neugenerierung aus den Settings                           | abgespaltener PR für die Account-Sektion                                                                                                  | **fertig** (PR #18 gemergt 16.06.)                                   | mittel | PR #18; Commit `b09a7e6`                                                                               | Auth-Krypto                             |
| AP-T.1         | Vitest Unit-Tests ≥70 % Branch       | Tests        | D     | Branch-Coverage ≥70 % (Stmts ≥80 %) in chunker/parser/RRF/Citation/Auth | 96 Tests grün; alle 5 Module über Schwelle; `test:cov:apt1`-Skript                                                                        | **fertig** (PR #24 gemergt 16.06.)                                   | hoch   | PR #24; `ap-t1-abschluss-doku.md`; Commits `0fcdef8`,`53441c1`                                         | —                                       |
| AP-T.2         | Integrationstests (§8.2 E2E)         | Tests        | D     | drei E2E-Suiten gegen reale Services + echte PGlite + erster CI-Job     | DocumentService-/RetrievalService-/Auth-E2E; 60-Chunk-Korpus; vitest-CI-Job + Electron-Stub                                               | **fertig** (PR #19 gemergt 16.06.)                                   | hoch   | PR #19; `ap-t2-abschluss-doku.md`; `Laborbericht…2026-06-12.md`; Commits `3e0a4d2`,`9644d60`,`48255ab` | DocumentService, RetrievalService, Auth |
...
| AP-E.1         | Eval-Dev-Set (50–80 Fälle)           | Eval         | D     | domänenspezifisches Dev-Set DE/EN mit Verteilung 30/70 + 60/25/15       | `cases.jsonl` mit 80 Fällen + Validator (386 Tests)                                                                                       | **fertig** (PR #25 gemergt 16.06.)                                   | hoch   | PR #25; `ap-e1-abschluss-doku.md`; Commit `27e159d`                                                    | Sample-Doc-Korpus, Chunker              |
| AP-E1b         | 15 Hold-out-Fälle (R5-Schutz)        | Eval         | D     | versiegeltes Hold-out gegen Echo-Kammer-Effekt                          | `dominik-15.jsonl` (9 ans / 4 ref / 2 partial)                                                                                            | **fertig (Code), im Review** (PR #28)                                | mittel | Commit `701bef1`; `ap-e1-abschluss-doku.md` (Abgrenzung)                                               | AP-E.1-Korpus                           |
...
Der in Tabelle 10.2 genannte DOCX-Import (Paket „Features: Quiz / DOCX-Import / Folder-Sync", AP-3.4) konvertiert Word-Dokumente über die Bibliothek _mammoth_ [15] nach Markdown; Tabellen werden dabei in Pipe-Zeilen überführt.
