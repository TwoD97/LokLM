...
| A2 | **Branch-Audit** der AP-/Eval-Kapitel gegen ihre Branches (`dom/ap-e2-matrix-eval`, `dom/ap-e1-eval-set`, `dom/ap-t1-unit-tests`, `dom/ap-t2-integrationstests`) statt gegen main | C | 11, 15, 17, 19 | 🌿 ☐ |
